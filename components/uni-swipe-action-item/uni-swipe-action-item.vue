<template>
	...
	<view class="uni-swipe">
		...
		<view class="uni-swipe_box" :change:prop="wxsswipe.showWatch" :data-threshold="threshold"
			...
			<view class="uni-swipe_box" :change:prop="renderswipe.showWatch" :data-threshold="threshold"
