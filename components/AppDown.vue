        ...
        <div class="ect-header-banner dis-box" id="ect-banner">
            ...
            <div class="box-flex">
                ...
                <div class="ect-header-text">
                    ...
                    <p style="font-size: 22rpx;">{{ configData && configData.h5_index_pro_small_title ? configData.h5_index_pro_small_title : ''}}</p>
                </div>
            </div>
			...
			uni.request({
				...
				success: (res) => {
					...
					if(res.data.status == 'success'){
						res.data.data.wap_index_pro == 1 ? (this.localShow = true) : (this.localShow = false)
