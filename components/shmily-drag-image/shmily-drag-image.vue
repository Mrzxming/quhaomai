            ...
            transform: 'scale(' + item.scale + ')' 
						...
						<view class="del-con" @click="delImages(item, index)" @touchstart.stop="delImageMp(item, index)"
							@touchend.stop="nothing()" @mousedown.stop="nothing()" @mouseup.stop="nothing()">
								<image class="del-image"
									src="https://shhai2.oss-cn-shanghai.aliyuncs.com/images/202504/thumb_img/47623_thumb_P_1745890134360.jpg">
								</image><!-- <image class="del-image"
				...
				<view class="add"
					...
					<view class="add-wrap"
						...
						<image style="width: 150rpx;height: 150rpx;" src="/static/add_ming.png">
						</image>
					</view>
				</view>
			</movable-area>
