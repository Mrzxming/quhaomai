	...
	<view class="drp-rank">
		...
		<view class="rank-box">
			...
			<view class="list" v-for="(item,index) in drpRankData.list" :key="index" @click="teamHref(item.shop_id)">
				<view class="left">
					<view class="icon">
						<image src="https://images.eqingqu.com/attachs/photo/202404/20240416_829D0422C5E08A8F169480B2CA138A6E.png" v-if="item.rank===1"></image>
						<image src="https://images.eqingqu.com/attachs/photo/202404/20240416_8DD84C27D0BD15FCD4761AC46A5FA873.png" v-if="item.rank===2"></image>
						<image src="https://images.eqingqu.com/attachs/photo/202404/20240416_C5A1C3BF2A7700E1E7134A688EA3942E.png" v-if="item.rank===3"></image>
