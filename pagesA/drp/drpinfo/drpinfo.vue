<template>
	<view class="drp-info tabbar-padding-bottom  allpage">
		...
		<view class="drp-warp">
			...
			<view class="header" :style="{'background-image':'url(' + drpInfoBg + ')'}">
				<view class="header-top">
					...
					<view class="header-right">
                        ...
                        <view class="rank">
							<view class="vip">
								<view class="icon"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_050DB5336B33DA80AAC9A9A036D9FE25.png" class="img" mode="widthFix"></image></view>
			...
			<!--  分销中心 -->
			<!-- <view class="invite_friends_button" style="margin-top: 50rpx;" @click="goinfoCenter()">
				 <text>分销中心</text>
				<uni-icons type="arrowright" color="#805223" size="24"></uni-icons>
			</view> -->
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			goinfoCenter(){
				uni.navigateTo({
					url:'../drpinfoCenter/drpinfoCenter'
				})
			},
			inviteFriends(){
				uni.navigateTo({
