	...
	<view class="container">
		...
		<view class="drp-select">
			<view class="header">
				<view class="header-warp">
					<view class="header-img"><image :src="drpdata.shop_info.shop_portrait" /></view>
			...
			<view class="drp-money-list" v-if="!isLoading">
				<view class="drp-items">
					<navigator :url="'./list/list?shop_id='+ drpdata.shop_info.id +'&parent_id='+drpdata.shop_info.user_id+'&model='+model" class="drp-item">
						<view class="icon"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_5638E1C5836F75921141EDDDB1C3C647.png" mode="widthFix"></image></view>
						<text>{{pageDrpStore.drp_goods ? pageDrpStore.drp_goods : $t('lang.my_represent')}}</text>
					</navigator>
					<navigator url="./order/order" class="drp-item">
						<view class="icon"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_E0717124C82344D1503E392C9FEF2427.png" mode="widthFix"></image></view>
					...
					<navigator :url="'./shop/shop?shop_id='+ drpdata.shop_info.id +'&parent_id='+drpdata.shop_info.user_id" class="drp-item">
						<view class="icon"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_42CAC9C13F601D121AA3B1FBD5AA27CF.png" mode="widthFix"></image></view>
					...
					<navigator url="./set/set" class="drp-item">
						<view class="icon"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_055269827AEDBC1935A21468CC8710B3.png" mode="widthFix"></image></view>
			...
			<view class="goods-list mt20">
				<view class="title">
					<image src="https://images.eqingqu.com/attachs/photo/202404/20240416_1B0EDD01A036E56C389F822A0088930D.png" class="icon"></image>
					<text>{{$t('lang.hot_goods')}}</text>
					<image src="https://images.eqingqu.com/attachs/photo/202404/20240416_59ADB823F7917FAA977CE7E55F532BAD.png" class="icon"></image>
				</view>
						...
						<view class="goods-right">
							...
							<!-- <view class="plan-box" v-if="item.commission == 1 && item.commission_money">
								<view class="commission-tag">
									<view class="num">{{$t('lang.commission_money')}}--可赚</view>
									<view class="cont-tag">{{item.commission_money_formated}}</view>
								</view>
							</view> -->
							<view class="plan-box" v-if="item.commission == 1 ">
								<view class="commission-tag">
									<view class="num2">{{item.dis_commission}}%</view>
									<view class="cont-tag2">佣金比例</view>
								</view>
							</view>
						</view>
					</view>
		...
		<block v-else>
			<view class="ectouch-notcont">
				<view class="img"><image src="https://shhai2.oss-cn-shanghai.aliyuncs.com/data/gallery_album/5/original_img/5_P_1705973845371.png" mode="widthFix"></image></view>
	...
	export default {
		...
		async onLoad(){
			...
			this.$store.dispatch('setMyDrp')
				...
				console.log('list',this.drpGoodsList);
		},
		onShow() {
			if(this.drpdata.shop_info){
