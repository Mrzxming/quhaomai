		...
		methods: {
			...
			onAddCartClicked(goods_id,type){
				this.$store.dispatch('setAddCart', {
					...
					if (res.data == true) {
						uni.navigateTo({
							url:'/pagesD/checkout/checkout?rec_type='+type
						});
					} else {
						uni.showToast({
							title:res.data.msg,
...
.vip-buy{
	...
	.title{
	    ...
	    &:before{ background-image: url(https://images.eqingqu.com/attachs/photo/202404/20240416_02F62ABB9E78DDB004A040D7E1920AE7.png); }
	    &:after{ background-image: url(https://images.eqingqu.com/attachs/photo/202404/20240416_6B3B97EE45BD6EBE5961FB6B843C8B5E.png); }
	}
    ...
    .p-content{
        ...
        .p-icon{
            ...
            .p-icon-success{
                width: 93.4upx;
                height: 93.4upx;
                background: url(https://images.eqingqu.com/attachs/photo/202404/20240416_CCBC217D346AADC54E119D79CBDABA00.png) no-repeat center;
