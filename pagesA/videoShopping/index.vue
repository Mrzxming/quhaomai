	...
	<view class="video-shopping">
		<view class="video-banner">
			<view class="image-view">
				<image src="https://shhai2.oss-cn-shanghai.aliyuncs.com/data/gallery_album/original_img/20230324_AsOT0my24vHsJ6gYsK5EXHa4WztIXR.png" mode="widthFix" class="img"></image>
				<view class="ju">
