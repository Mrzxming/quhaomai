				...
				<view class="header-top">
					...
					<view class="header-right">
						...
						<view class="rank">
							<view class="vip">
								<view class="icon">
									<image src="https://images.eqingqu.com/attachs/photo/202404/20240416_8972F9C38B7C53B241485F879727BAD2.png" class="img" mode="widthFix"></image>
								</view>
								<text>视频号推广员</text>
							</view>
						</view>
		...
		<view class="team-box">
			...
			<view class="items">
				<view class="item item1" @click="$outerHref('/pagesA/videoShopping/profit','app')">
					<view class="num"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_C9746B1A58ECD9591DF73CAAE923665D.png" mode="widthFix" class="img"></image></view>
					<icon class="link"></icon>
					<text class="text">收益明细</text>
				</view>
				<view class="item item2" @click="$outerHref('/pagesA/videoShopping/order','app')">
					<view class="num"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_429A5B97F1ED76E3FE672F8E7A614EFB.png" mode="widthFix" class="img"></image></view>
					<icon class="link"></icon>
					<text class="text">商品订单</text>
				</view>
				<view class="item item3" @click="$outerHref('/pagesA/videoShopping/goods','app')">
					<view class="num"><image src="https://images.eqingqu.com/attachs/photo/202404/20240416_1BE837EA41DE5F1114B866EC6EB9919E.png" mode="widthFix" class="img"></image></view>
					<icon class="link"></icon>
