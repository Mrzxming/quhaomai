								...
								<view class="user-cell-list" v-for="(item, index) in crowdShowData.topic_list" :key="index">
									<view class="top uni-flex-common">
										<view class="left">
											...
											<image src="https://images.eqingqu.com/attachs/photo/202404/20240416_A18137536D3CE3482124A4EA80F3095A.png" class="img" v-else />
										</view>
										<view class="right uni-flex-item">
...
export default {
    ...
    methods: {
		...
		appShare() {
			let shareInfo = {
				href: `${this.$websiteUrl}crowdfunding/detail/${this.id}?parent_id=${uni.getStorageSync("user_id")}&splatform=APP`,
				title: this.crowdShowData.info.title,
				summary: '',
