...
.seckill-new-style .header-top ::v-deep .data-time{
    font-size: 1.4rem;
}
.seckill-new-style .header-top ::v-deep .data-time span{
...
.seckill-new-style .header-top ::v-deep .data-time i{
    font-size: 1.2rem;
    color: #F20D23;
    font-size: 1.6rem;
    font-weight: 700;
...
.seckill-new-style .header-top ::v-deep .data-time strong{
    font-size: 1.2rem;
    color: #333;
    font-weight: 400;
    margin-right: 1.2rem;
