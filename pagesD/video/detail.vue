			...
			<view class="swiper" v-if="goodsInfo">
				<view class="swiper-item">
					<view class="video-box">
						...
						<cover-view class="goods-info" @click="hrefClick">
						...
						<cover-image class="video_close_btn" src="https://images.eqingqu.com/attachs/photo/202404/20240416_5A225965DF8980155312C153DC33C6CC.png" @click="goBackList"></cover-image>
						<cover-view class="cover-view-right">
							<cover-image :src="goodsInfo.is_collect == 1 ? 'https://images.eqingqu.com/attachs/photo/202404/20240416_FC1FEDEC3BCD38EF866B8FEE88BE4302.png' : 'https://images.eqingqu.com/attachs/photo/202404/20240416_784F4F717FAB714BD6A549CA31BAAB1B.png'" class="icon" @click.stop="tapLove(goodsInfo.is_collect)"></cover-image>
							<cover-view class="right-text">{{goodsInfo.user_collect}}</cover-view>
							<cover-image src="https://images.eqingqu.com/attachs/photo/202404/20240416_C453305BCE8689B5091119402ED93932.png" class="icon" @click.stop="tapMsg"></cover-image>
							<cover-view class="right-text">{{goodsInfo.comment_num}}</cover-view>
							<!-- #ifdef APP-PLUS -->
							<cover-image src="https://images.eqingqu.com/attachs/photo/202404/20240416_0E2A76016367D25D5AD42E4187795F23.png" class="icon" @click.stop="appShare(item)"></cover-image>
							<cover-view class="right-text">{{$t('lang.share')}}</cover-view>
							<!-- #endif -->
							<!-- #ifdef MP-WEIXIN -->
							<button class="button-share" open-type="share">
								<cover-image src="https://images.eqingqu.com/attachs/photo/202404/20240416_0E2A76016367D25D5AD42E4187795F23.png" class="icon"></cover-image>
							</button>
							<cover-view class="right-text">{{$t('lang.share')}}</cover-view>
							<!-- #endif -->
						</cover-view>
...
<script>
	...
	export default{
		...
		methods:{
			...
			hrefClick(){
				uni.redirectTo({
					url:'/pagesC/goodsDetail/goodsDetail?id='+this.goodsInfo.goods_id
				})
			},
			goBackList() {
				uni.navigateBack({
