...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showGatherModal(store) {
        ...
        modal.innerHTML = `
            <div class="modal-container">
                <div class="modal-header">
                    <h3 class="modal-title">去凑单</h3>
                    <div class="gather-header-right">
                        <svg class="icon store-icon"><use href="#icon-store"/></svg>
                        <span class="gather-header-store">${store}</span>
                        <span class="gather-header-divider">·</span>
                        <span class="gather-enter-store">进店</span>
                        <svg class="icon gather-enter-arrow"><use href="#icon-arrow-right"/></svg>
                    </div>
                ...
                <div class="modal-body">
                    <div class="modal-content-scroll">
                        <div class="gather-activity-bar">
                            <span class="gather-activity-text">再选<span class="highlight">32</span>立省<span class="highlight">20</span></span>
                            <span class="gather-activity-rule">满199减30活动</span>
                        </div>
        ...
        if (svgDefs) modal.insertBefore(svgDefs.cloneNode(true), modal.firstChild);
        ...
        const modal = createModal('凑单优惠 - ' + store, `
            <div class="modal-content-scroll">
                <div class="gather-tip-box">
                    <p>再选<span class="highlight">${needAmount}</span>立省<span class="highlight">${saveAmount}</span></p>
                </div>
