        ...
        <view style="width: 750rpx;height: 100vh;">
            <view class="pass-box">
                <view class="pass-box-head">
                    ...
                    <view class="pass-box-head__title" style="font-size: 32rpx;margin-top: 50rpx;">
                        请输入支付密码
                    </view>
                <view class="pass-box-center" style="margin: 50rpx 0;">
...
<!--                    <view class="pass-box-center__money" v-if="money"> -->
            ...
            <view class="keyboard">
                ...
                <view v-for="(item,index) in 9" :key="index" hover-class="key-hover" :hover-stay-time="100"
                    class="keyboard-key" @tap="keyTap(item+1)">
                    {{item+1}}
                </view>
                <!-- #endif -->
				<!-- #ifndef MP-WEIXIN -->
