...
<style>
/* .drp-info{ padding-bottom: 50upx; height: 100vh;background: linear-gradient(0deg, #565555, #1c1c1c);} */
.drp-info{ height: calc(100vh - 44px) !important; background: linear-gradient(0deg, #565555, #1c1c1c); }
.drp-warp{ padding: 20upx 20upx 120upx 20upx;}
