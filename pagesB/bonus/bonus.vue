			...
			<view class="bonus-item" v-for="(item,index) in bonusData" :key="index">
				<view class="cont">
					...
					<view class="bonus-image" v-else>
						<image src="https://shhai2.oss-cn-shanghai.aliyuncs.com/data/gallery_album/5/original_img/5_P_1705973843248.png" class="img" v-if="status == 1"></image>
						<image src="https://shhai2.oss-cn-shanghai.aliyuncs.com/data/gallery_album/5/original_img/5_P_1705973842253.png" v-if="status == 2" class="img"></image>
					</view>
				</view>
