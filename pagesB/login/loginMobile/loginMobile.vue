	...
	<view class="container-bwg">
		<view class="user-lr-form">
			...
			<form @submit="formSubmit">
				...
				<navigator url="/pagesB/login/login?loginMode=password" class="list-new" hover-class="none">{{$t('lang.account_pwd_login')}}<uni-icons color="#f92028" type="arrowright" size='20'></uni-icons></navigator>
			</form>
		</view>
	</view>
